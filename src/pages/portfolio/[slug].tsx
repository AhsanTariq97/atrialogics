    ...
    <>
        ...
        <main className='overflow-x-hidden'>
            ...
            <main className='max-w-screen-xl mx-auto'>
                <div className='flex flex-col justify-between items-start px-8 pb-16 md:space-y-16 mx-auto max-w-2xl lg:max-w-full'>
                  <ProjectPage frontmatter={frontmatter} source={source} />
                  <Link href='/portfolio'>&larr; Back to Blog</Link>
                </div>
            </main>
