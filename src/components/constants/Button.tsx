...
const Button: React.FC<ButtonProps> = ({ type, text }) => {
  return (
    <button type={type} className={`px-12 py-[10px] bg-[#7187A2] font-bold text-lg tracking-wide rounded-full shadow-button text-white outline-none hover:bg-[#75C3B9]`}>{text}</button>
