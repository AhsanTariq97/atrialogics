...
const Button: React.FC<ButtonProps> = ({ type, text, px }) => {
  return (
    <button type={type} className={`px-${px ? px : '12'} py-1 text-[#7187A2] border-2 border-[#7187A2] font-normal text-lg tracking-wide rounded-full shadow-button hover:text-white outline-none hover:bg-[#010661] hover:border-[#010661]`}>{text}</button>
