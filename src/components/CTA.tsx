...
const CTA: React.FC = () => {
  ...
  return (
    <div className='px-8 py-16 pb-32'>
        <div data-aos='fade-up' className='flex flex-col justify-between items-center space-y-8 px-4 md:px-16 py-8 max-w-2xl lg:max-w-5xl mx-auto rounded-xl shadow-xl shadow-gray-300'>
