        ...
        <div className='w-full max-w-screen-xl'>
            <div className='relative flex flex-row items-start justify-between'>
                ...
                <div ref={mySidebarRef} className={`p-2 pl-8 hidden md:flex flex-col justify-between items-start space-y-8
                    ...
                    {headings.length > 0 && <div className='border border-[#c7c7c7] rounded-3xl px-4 py-2 w-full '>
                    ...
                    {/* <div className='flex flex-col items-start justify-between space-y-4 w-full rounded-lg p-4 border border-[#c7c7c7]'>
                        ...
                        <form className='flex flex-col items-start justify-between w-full space-y-2 text-xs' ref={form} onSubmit={handleSubmit((data) => {
                            ...
                            <button type="submit" className='text-[#7187A2] border border-[#7187A2] px-4 py-2 rounded-full cursor-pointer hover:bg-[#010661] hover:text-white hover:border-[#010661]' >Submit</button>
                        </form>
                    </div> */}
                    ...
                    <div className='flex flex-col items-start justify-between space-y-4 w-full rounded-lg p-4 border border-[#c7c7c7]'>
                        ...
                        <div className='flex items-center justify-between w-full'>
                            ...
                            <AiFillLinkedin size={40} className='text-[#7187A2] hover:text-[#010661]' />
                            <AiFillFacebook size={40} className='text-[#7187A2] hover:text-[#010661]' />
                            <AiOutlineTwitter size={40} className='text-[#7187A2] hover:text-[#010661]' />
                        </div>
                    </div>
