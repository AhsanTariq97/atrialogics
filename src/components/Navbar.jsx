        ...
        <nav className='relative w-full mx-auto max-w-screen-xl h-[100px] pt-4'>
            <div className='flex flex-row justify-between items-center px-8'>
                ...
                <ul className={'hidden lg:flex flex-row justify-center items-center'}>
                    ...
                    <li className='px-4 py-2 tracking-wide'><Link href="/"><p className='text-base font-normal tracking-wide'>Services</p></Link></li>
                    <li className='px-4 py-2 tracking-wide'><Link href="/"><p className='text-base font-normal tracking-wide'>About</p></Link></li>
                    <li className='px-4 py-2 tracking-wide'><Link href="/"><p className='text-base font-normal tracking-wide'>Team</p></Link></li>
                    <li className='px-4 py-2 tracking-wide'><Link href="/"><p className='text-base font-normal tracking-wide'>Contact</p></Link></li>
                </ul>
